...
ORDER BY dept_no ASC LIMIT 100;
--SQL_CHALLENGE
--John Wittenborn

--Check contents of imported CSV tables
...
SELECT employees.emp_no, employees.last_name, employees.first_name, dept_emp.dept_no, dept_name
FROM dept_emp
JOIN employees
